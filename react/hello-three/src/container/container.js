...
import Tankuang from'../conponent/tankuang';
import logoa from '../conponent/img/she.png';
import logob from '../conponent/img/fanhui.png';
import TankuangTwo from '../norepeat/tankuang_two.js';
...
let str1= {
 ...
 class Container extends Component {
    constructor(props) {
        ...
        this.bianMask = this.bianMask.bind(this);
    ...
    render() {
        ...
        if(this.props.location.pathname=="/student/repos"){
            ...
            children = React.cloneElement(this.props.children, {
                rewards:this.state.data.rewards,
                student:this.state.data.students[this.state.num],
        ...
        return (
            <div className="scroll" onScroll={this.changeScroll} ref="container">
                <Head grade={{...this.state.data.grade,...this.state.data.period}}
         courseList={this.state.data.courseList}
                      img={this.props.location.pathname=="/student/repos"?logoa:logob}
                      click={this.click}/>
                <div className="box">
                    {
                        children
             ...
             if (this.props.location.pathname == "/student/repos") {
              return <Tankuang
                  flag={this.state.flag}
                     ...
                     reward={this.state.data.rewards[this.state.num]}
                     changeScore={ this.changeScore}/>
             } else {
                 return <TankuangTwo
                     flag={this.state.flag}
                     cancelMask={this.cancelMask}
                     students={this.state.data.students[this.state.num]}
                     students={this.state.data.students}
                 />
             }
         }
     ...
     changeScroll(e){
         if(this.props.location.pathname=="/student/three"){
...
export default connect(maneger,mapDispatchToProps)(Container);