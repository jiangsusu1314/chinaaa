...
import HeadTwo from '../conponent/headtwo';
import Content from '../conponent/contenttwo';
import Contenter from '../conponent/content_er';
import {leftLinkRight} from './actions'
import {topLinklogo} from './actions'
import LeftSelect from'../conponent/left_selectwot';
let str1= {
    "message": "登录成功",
    "students": [{
        "id": 1,
...
class Super extends Component {
    ...
    render() {
        ...
        return (
         <div>
             <HeadTwo store={this.props}/>
             <div className="box">
                 {
                     this.props.set==1?<Content store={this.props}/>:<Contenter store={this.props}/>

                 }
                 <LeftSelect store={this.props}/>
             </div>
         </div>
        );
    }
